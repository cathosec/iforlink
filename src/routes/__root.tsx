...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ForLink — Seu link na bio, organizado" },
      { name: "description", content: "Reúna todos os seus links em um perfil público bonito e organizado por categorias. Criação em minutos, grátis." },
      { property: "og:title", content: "ForLink — Seu link na bio, organizado" },
      { property: "og:description", content: "Reúna todos os seus links em um perfil público bonito e organizado por categorias." },
