-- 1) Fix created_at -> received_at in admin_ops_summary
...
-- 2) Drop session replay artifacts
...
-- 3) Rebuild delete/export RPCs without recordings
...
BEGIN
  ...
  PERFORM public.log_event(
    ...
    jsonb_build_object('sessions', del_sessions),
    'info',
    'user',
    uid::text
  );
